...
wget -O /var/cache/apt/archives/libssl1.0.0_1.0.1t-1+deb8u7_amd64.deb http://security.debian.org/debian-security/pool/updates/main/o/openssl/libssl1.0.0_1.0.1t-1+deb8u7_amd64.deb 2>&1
dpkg -i /var/cache/apt/archives/libssl1.0.0_1.0.1t-1+deb8u7_amd64.deb
