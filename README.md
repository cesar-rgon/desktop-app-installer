...
```
Tested on:   Ubuntu 16.04 LTS Xenial, Debian 9 Stretch, Linux Mint 18 Sarah, LMDE 2 Betsy and Raspbian Jessie (desktop or server).
             With some changes in config files, it can be 100% compatible with previous versions.
Version:     1.3.3
Last change: 2017/03/20 (yyyy/mm/dd)
```
